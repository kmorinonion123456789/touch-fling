-- Universal Touch Fling (Open Source - 完成版)
-- LocalScriptとして使用（StarterPlayer > StarterPlayerScripts に置くか、Executorで実行）
-- 特徴: GUI付き（ON/OFF, Power調整, Hide） / 自分は安定 / 触れた相手だけ超飛ぶ
-- 調整: Powerスライダーで強さ変更（デフォ5000-55000）
